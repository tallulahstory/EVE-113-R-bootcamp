...
The second option to set your working directiory is the point-and-click approach (I personally prefer setting my directory manually, but others might like this better).
...
For the sake of this course (and these tutorials), I suggest making a folder to set as your working directory before we proceed any further. You can use the following template if you'd like to keep things simple:
